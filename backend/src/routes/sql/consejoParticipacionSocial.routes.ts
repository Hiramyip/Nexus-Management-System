...
import { ConsejoParticipacionSocialService } from '../../services/sql/ConsejoParticipacionSocialService.js';
const router = Router(); const service = new ConsejoParticipacionSocialService();
